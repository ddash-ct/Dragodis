...
class Line(metaclass=abc.ABCMeta):
    ...
    def is_float(self) -> bool:
        """
        Convenience property for determining if the line is a float type.
        """
    ...
    def is_integer(self) -> bool:
        """
        Convenience property for determining if the line is an integer.
        """
    ...
    def is_string(self) -> bool:
        """
        Convenience property for determining if the line is a string (with any encoding).
        """
